...
use Doctrine\ORMLess\Mapping\ClassMetadataFactory;

class ObjectManager implements ObjectManagerInterface
{
    /**
     * @var \Doctrine\ORMLess\ObjectRepositoryFactoryInterface
     */
    private $objectRepositoryFactory;

    /**
     * @var \Doctrine\ORMLess\ObjectPersisterFactoryInterface
     */
    private $objectPersisterFactory;

    /**
     * @var \Doctrine\ORMLess\UnitOfWorkInterface
     */
    private $unitOfWork;

    /**
     * @var \Doctrine\ORMLess\Mapping\ClassMetadataFactory
     */
    private $metadataFactory;

    /**
     * @param \Doctrine\ORMLess\ObjectRepositoryFactoryInterface $objectRepositoryFactory
     * @param \Doctrine\ORMLess\ObjectPersisterFactoryInterface  $objectPersisterFactory
     * @param \Doctrine\ORMLess\UnitOfWorkInterface              $unitOfWork
     * @param \Doctrine\ORMLess\Mapping\ClassMetadataFactory     $metadataFactory
     */
