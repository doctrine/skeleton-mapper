...
namespace Doctrine\ORMLess\Tests\Functional;

use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\ORMLess;
use Doctrine\ORMLess\Tests\TestImplementation\User\User;
use Doctrine\ORMLess\Tests\TestImplementation\User\UserDataRepository;
use Doctrine\ORMLess\Tests\TestImplementation\User\UserHydrator;
use Doctrine\ORMLess\Tests\TestImplementation\User\UserPersister;
use Doctrine\ORMLess\Tests\TestImplementation\User\UserRepository;
...
class FunctionalTest extends PHPUnit_Framework_TestCase
{
    ...
    protected $users;
    protected $testClassName = 'Doctrine\ORMLess\Tests\TestImplementation\User\User';
    ...
    protected function setUp()
    {
        ...
        $objectFactory = new ORMLess\ObjectFactory();
        $objectRepositoryFactory = new ORMLess\ObjectRepositoryFactory();
        $objectPersisterFactory = new ORMLess\ObjectPersisterFactory();
        $objectIdentityMap = new ORMLess\ObjectIdentityMap($objectRepositoryFactory);

        // user class metadata
        $userClassMetadata = new ORMLess\Mapping\ClassMetadata($this->testClassName);
        $userClassMetadata->identifier = array('id');
        $userClassMetadata->autoMapFields();

        $classMetadataFactory = new ORMLess\Mapping\ClassMetadataFactory();
        ...
        $unitOfWork = new ORMLess\UnitOfWork(
            $objectPersisterFactory,
            $objectRepositoryFactory,
            $objectIdentityMap
        );

        $this->objectManager = new ORMLess\ObjectManager(
            $objectRepositoryFactory,
            $objectPersisterFactory,
            $unitOfWork,
